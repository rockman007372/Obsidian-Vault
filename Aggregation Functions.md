Aggregation functions in SQL compute **a single value** from a set of tuples.
...
You can apply functions over distinct values.
- Take note that `IS DISTINCT` operation is used to check (Eg. NULL IS DISTINCT FROM NULL == TRUE)
